...
@XmlType(
        name = "MailboxHoldStatusType",
        propOrder = {"mailbox", "status", "additionalInfo"})
public class MailboxHoldStatusType {
     ...
     *
     * @return possible object is {@link HoldStatusType }
     */
     ...
     *
     * @param value allowed object is {@link HoldStatusType }
     */
