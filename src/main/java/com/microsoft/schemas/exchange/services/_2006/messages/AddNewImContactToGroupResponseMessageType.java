...
/**
 * Java class for AddNewImContactToGroupResponseMessageType complex type.
 *
...
@XmlType(
        name = "AddNewImContactToGroupResponseMessageType",
        propOrder = {"persona"})
public class AddNewImContactToGroupResponseMessageType extends ResponseMessageType {
