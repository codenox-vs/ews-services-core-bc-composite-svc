...
@XmlType(
        name = "ArrayOfMailboxStatisticsItemsType",
        propOrder = {"mailboxStat"})
public class ArrayOfMailboxStatisticsItemsType {
     ...
     * why there is not a <CODE>set</CODE> method for the mailboxStat property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MailboxStatisticsItemType
     * }
     */
