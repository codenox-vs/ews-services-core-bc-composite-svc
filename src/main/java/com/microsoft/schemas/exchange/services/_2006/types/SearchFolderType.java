...
@XmlType(
        name = "SearchFolderType",
        propOrder = {"searchParameters"})
public class SearchFolderType extends FolderType {
     ...
     *
     * @return possible object is {@link SearchParametersType }
     */
     ...
     *
     * @param value allowed object is {@link SearchParametersType }
     */
