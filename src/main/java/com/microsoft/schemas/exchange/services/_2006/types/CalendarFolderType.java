...
/**
 * Java class for CalendarFolderType complex type.
 *
...
@XmlType(
        name = "CalendarFolderType",
        propOrder = {"sharingEffectiveRights", "permissionSet"})
public class CalendarFolderType extends BaseFolderType {
     ...
     *
     * @return possible object is {@link CalendarPermissionReadAccessType }
     */
     ...
     *
     * @param value allowed object is {@link CalendarPermissionReadAccessType }
     */
     ...
     *
     * @return possible object is {@link CalendarPermissionSetType }
     */
     ...
     *
     * @param value allowed object is {@link CalendarPermissionSetType }
     */
