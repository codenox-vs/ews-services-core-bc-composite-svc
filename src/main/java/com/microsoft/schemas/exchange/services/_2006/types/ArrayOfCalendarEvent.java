...
/**
 * Java class for ArrayOfCalendarEvent complex type.
 *
...
@XmlType(
        name = "ArrayOfCalendarEvent",
        propOrder = {"calendarEvent"})
public class ArrayOfCalendarEvent {
     ...
     * why there is not a <CODE>set</CODE> method for the calendarEvent property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link CalendarEvent }
     */
