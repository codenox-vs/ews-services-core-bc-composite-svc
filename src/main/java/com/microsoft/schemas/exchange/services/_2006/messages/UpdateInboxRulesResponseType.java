...
/**
 * Java class for UpdateInboxRulesResponseType complex type.
 *
...
@XmlType(
        name = "UpdateInboxRulesResponseType",
        propOrder = {"ruleOperationErrors"})
public class UpdateInboxRulesResponseType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfRuleOperationErrorsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfRuleOperationErrorsType }
     */
