...
/**
 * Java class for ArrayOfRuleOperationErrorsType complex type.
 *
...
@XmlType(
        name = "ArrayOfRuleOperationErrorsType",
        propOrder = {"ruleOperationError"})
public class ArrayOfRuleOperationErrorsType {
     ...
     * why there is not a <CODE>set</CODE> method for the ruleOperationError property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link RuleOperationErrorType }
     */
