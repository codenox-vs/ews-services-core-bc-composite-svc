...
/**
 * Java class for GetPasswordExpirationDateType complex type.
 *
...
@XmlType(
        name = "GetPasswordExpirationDateType",
        propOrder = {"mailboxSmtpAddress"})
public class GetPasswordExpirationDateType extends BaseRequestType {
