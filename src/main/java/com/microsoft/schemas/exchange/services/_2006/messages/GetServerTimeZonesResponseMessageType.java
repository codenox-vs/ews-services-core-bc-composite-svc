...
/**
 * Java class for GetServerTimeZonesResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetServerTimeZonesResponseMessageType",
        propOrder = {"timeZoneDefinitions"})
public class GetServerTimeZonesResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfTimeZoneDefinitionType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfTimeZoneDefinitionType }
     */
