...
/**
 * Java class for NonEmptyArrayOfGroupIdentifiersType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfGroupIdentifiersType",
        propOrder = {"groupIdentifier"})
public class NonEmptyArrayOfGroupIdentifiersType {
     ...
     * why there is not a <CODE>set</CODE> method for the groupIdentifier property.
     *
