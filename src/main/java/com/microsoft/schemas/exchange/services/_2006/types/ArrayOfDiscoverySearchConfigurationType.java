...
@XmlType(
        name = "ArrayOfDiscoverySearchConfigurationType",
        propOrder = {"discoverySearchConfiguration"})
public class ArrayOfDiscoverySearchConfigurationType {
     ...
     * why there is not a <CODE>set</CODE> method for the discoverySearchConfiguration property.
     *
