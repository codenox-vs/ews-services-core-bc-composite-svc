...
@XmlType(
        name = "GetNonIndexableItemDetailsType",
        propOrder = {
            "mailboxes",
            "pageSize",
            "pageItemReference",
...
public class GetNonIndexableItemDetailsType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfLegacyDNsType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfLegacyDNsType }
     */
