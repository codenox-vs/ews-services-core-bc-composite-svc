...
/**
 * Java class for ArrayOfEncryptedSharedFolderDataType complex type.
 *
...
@XmlType(
        name = "ArrayOfEncryptedSharedFolderDataType",
        propOrder = {"encryptedSharedFolderData"})
public class ArrayOfEncryptedSharedFolderDataType {
     ...
     * why there is not a <CODE>set</CODE> method for the encryptedSharedFolderData property.
     *
