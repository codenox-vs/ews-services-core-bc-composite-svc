...
/**
 * Java class for WeeklyRecurrencePatternType complex type.
 *
...
@XmlType(
        name = "WeeklyRecurrencePatternType",
        propOrder = {"daysOfWeek", "firstDayOfWeek"})
public class WeeklyRecurrencePatternType extends IntervalRecurrencePatternBaseType {
     ...
     * why there is not a <CODE>set</CODE> method for the daysOfWeek property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link DayOfWeekType }
     */
