...
/**
 * Java class for NonEmptyArrayOfFolderChangesType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfFolderChangesType",
        propOrder = {"folderChange"})
public class NonEmptyArrayOfFolderChangesType {
     ...
     * why there is not a <CODE>set</CODE> method for the folderChange property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link FolderChangeType }
     */
