...
@XmlType(
        name = "PermissionType",
        propOrder = {"readItems", "permissionLevel"})
public class PermissionType extends BasePermissionType {
     ...
     *
     * @return possible object is {@link PermissionLevelType }
     */
     ...
     *
     * @param value allowed object is {@link PermissionLevelType }
     */
