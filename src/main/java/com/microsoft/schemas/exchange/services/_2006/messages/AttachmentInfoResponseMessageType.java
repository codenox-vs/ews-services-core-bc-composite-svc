...
/**
 * Java class for AttachmentInfoResponseMessageType complex type.
 *
...
@XmlType(
        name = "AttachmentInfoResponseMessageType",
        propOrder = {"attachments"})
public class AttachmentInfoResponseMessageType extends ResponseMessageType {
