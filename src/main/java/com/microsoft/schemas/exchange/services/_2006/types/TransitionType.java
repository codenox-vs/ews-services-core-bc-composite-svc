...
@XmlType(
        name = "TransitionType",
        propOrder = {"to"})
@XmlSeeAlso({AbsoluteDateTransitionType.class, RecurringTimeTransitionType.class})
public class TransitionType {
     ...
     *
     * @return possible object is {@link TransitionTargetType }
     */
     ...
     *
     * @param value allowed object is {@link TransitionTargetType }
     */
