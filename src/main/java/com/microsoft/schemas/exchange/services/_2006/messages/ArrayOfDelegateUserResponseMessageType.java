...
/**
 * Java class for ArrayOfDelegateUserResponseMessageType complex type.
 *
...
@XmlType(
        name = "ArrayOfDelegateUserResponseMessageType",
        propOrder = {"delegateUserResponseMessageType"})
public class ArrayOfDelegateUserResponseMessageType {
     ...
     * why there is not a <CODE>set</CODE> method for the delegateUserResponseMessageType property.
     *
