...
/**
 * Java class for GetPhoneCallInformationType complex type.
 *
...
@XmlType(
        name = "GetPhoneCallInformationType",
        propOrder = {"phoneCallId"})
public class GetPhoneCallInformationType extends BaseRequestType {
