...
/**
 * Java class for RecurringDayTransitionType complex type.
 *
...
@XmlType(
        name = "RecurringDayTransitionType",
        propOrder = {"dayOfWeek", "occurrence"})
public class RecurringDayTransitionType extends RecurringTimeTransitionType {
