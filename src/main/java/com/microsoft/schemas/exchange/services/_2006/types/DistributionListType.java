...
@XmlType(
        name = "DistributionListType",
        propOrder = {"displayName", "fileAs", "contactSource", "members"})
public class DistributionListType extends ItemType {
     ...
     *
     * @return possible object is {@link MembersListType }
     */
     ...
     *
     * @param value allowed object is {@link MembersListType }
     */
