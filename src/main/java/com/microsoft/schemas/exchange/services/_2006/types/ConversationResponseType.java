...
/**
 * Java class for ConversationResponseType complex type.
 *
...
@XmlType(
        name = "ConversationResponseType",
        propOrder = {"conversationId", "syncState", "conversationNodes"})
public class ConversationResponseType {
     ...
     *
     * @return possible object is {@link ArrayOfConversationNodesType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfConversationNodesType }
     */
