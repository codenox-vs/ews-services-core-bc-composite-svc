...
/**
 * Java class for NonEmptyArrayOfDeletedOccurrencesType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfDeletedOccurrencesType",
        propOrder = {"deletedOccurrence"})
public class NonEmptyArrayOfDeletedOccurrencesType {
     ...
     * why there is not a <CODE>set</CODE> method for the deletedOccurrence property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link DeletedOccurrenceInfoType
     * }
     */
