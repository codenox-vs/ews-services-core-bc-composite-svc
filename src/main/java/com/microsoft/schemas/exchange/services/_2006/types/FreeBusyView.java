...
@XmlType(
        name = "FreeBusyView",
        propOrder = {"freeBusyViewType", "mergedFreeBusy", "calendarEventArray", "workingHours"})
public class FreeBusyView {
     ...
     * why there is not a <CODE>set</CODE> method for the freeBusyViewType property.
     *
     ...
     *
     * @return possible object is {@link ArrayOfCalendarEvent }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfCalendarEvent }
     */
     ...
     *
     * @return possible object is {@link WorkingHours }
     */
     ...
     *
     * @param value allowed object is {@link WorkingHours }
     */
