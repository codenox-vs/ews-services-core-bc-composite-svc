...
/**
 * Java class for UpdateItemResponseMessageType complex type.
 *
...
@XmlType(
        name = "UpdateItemResponseMessageType",
        propOrder = {"conflictResults"})
public class UpdateItemResponseMessageType extends ItemInfoResponseMessageType {
