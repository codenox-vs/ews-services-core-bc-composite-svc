...
/**
 * Java class for SuggestionsResponseType complex type.
 *
...
@XmlType(
        name = "SuggestionsResponseType",
        propOrder = {"responseMessage", "suggestionDayResultArray"})
public class SuggestionsResponseType {
     ...
     *
     * @return possible object is {@link ArrayOfSuggestionDayResult }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfSuggestionDayResult }
     */
