...
/**
 * Java class for ArrayOfTrackingPropertiesType complex type.
 *
...
@XmlType(
        name = "ArrayOfTrackingPropertiesType",
        propOrder = {"trackingPropertyType"})
public class ArrayOfTrackingPropertiesType {
     ...
     * why there is not a <CODE>set</CODE> method for the trackingPropertyType property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link TrackingPropertyType }
     */
