...
/**
 * Java class for ArrayOfRecipientTrackingEventType complex type.
 *
...
@XmlType(
        name = "ArrayOfRecipientTrackingEventType",
        propOrder = {"recipientTrackingEvent"})
public class ArrayOfRecipientTrackingEventType {
     ...
     * why there is not a <CODE>set</CODE> method for the recipientTrackingEvent property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link RecipientTrackingEventType
     * }
     */
