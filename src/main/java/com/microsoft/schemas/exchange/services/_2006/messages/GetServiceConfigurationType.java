...
import com.microsoft.schemas.exchange.services._2006.types.ConfigurationRequestDetailsType;
...
/**
 * Java class for GetServiceConfigurationType complex type.
 *
...
@XmlType(
        name = "GetServiceConfigurationType",
        propOrder = {"actingAs", "requestedConfiguration", "configurationRequestDetails"})
public class GetServiceConfigurationType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link ArrayOfServiceConfigurationType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfServiceConfigurationType }
     */
     ...
     *
     * @return possible object is {@link ConfigurationRequestDetailsType }
     */
     ...
     *
     * @param value allowed object is {@link ConfigurationRequestDetailsType }
     */
