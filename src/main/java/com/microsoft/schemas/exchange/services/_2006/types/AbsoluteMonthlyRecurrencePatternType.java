...
/**
 * Java class for AbsoluteMonthlyRecurrencePatternType complex type.
 *
...
@XmlType(
        name = "AbsoluteMonthlyRecurrencePatternType",
        propOrder = {"dayOfMonth"})
public class AbsoluteMonthlyRecurrencePatternType extends IntervalRecurrencePatternBaseType {
