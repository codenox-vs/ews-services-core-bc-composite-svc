...
@XmlType(
        name = "GroupByType",
        propOrder = {"fieldURI", "indexedFieldURI", "extendedFieldURI", "aggregateOn"})
public class GroupByType extends BaseGroupByType {
     ...
     *
     * @return possible object is {@link AggregateOnType }
     */
     ...
     *
     * @param value allowed object is {@link AggregateOnType }
     */
