...
@XmlType(
        name = "ArrayOfNonIndexableItemStatisticsType",
        propOrder = {"nonIndexableItemStatistic"})
public class ArrayOfNonIndexableItemStatisticsType {
     ...
     * why there is not a <CODE>set</CODE> method for the nonIndexableItemStatistic property.
     *
