...
/**
 * Java class for GetMessageTrackingReportRequestType complex type.
 *
...
@XmlType(
        name = "GetMessageTrackingReportRequestType",
        propOrder = {
            "scope",
            "reportTemplate",
            "recipientFilter",
...
public class GetMessageTrackingReportRequestType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link MessageTrackingReportTemplateType }
     */
     ...
     *
     * @param value allowed object is {@link MessageTrackingReportTemplateType }
     */
