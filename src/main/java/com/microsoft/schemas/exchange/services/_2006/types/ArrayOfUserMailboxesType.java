...
@XmlType(
        name = "ArrayOfUserMailboxesType",
        propOrder = {"userMailbox"})
public class ArrayOfUserMailboxesType {
     ...
     * why there is not a <CODE>set</CODE> method for the userMailbox property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link UserMailboxType }
     */
