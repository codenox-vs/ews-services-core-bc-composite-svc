...
/**
 * Java class for StringArrayAttributedValueType complex type.
 *
...
@XmlType(
        name = "StringArrayAttributedValueType",
        propOrder = {"values", "attributions"})
public class StringArrayAttributedValueType {
     ...
     *
     * @return possible object is {@link ArrayOfStringValueType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfStringValueType }
     */
