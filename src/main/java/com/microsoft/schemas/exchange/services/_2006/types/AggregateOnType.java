...
/**
 * Represents the field of each item to aggregate on and the qualifier to apply to that field in
 * determining which item will represent the group.
 *
...
@XmlType(
        name = "AggregateOnType",
        propOrder = {"fieldURI", "indexedFieldURI", "extendedFieldURI"})
public class AggregateOnType {
     ...
     *
     * @return possible object is {@link PathToUnindexedFieldType }
     */
     ...
     *
     * @param value allowed object is {@link PathToUnindexedFieldType }
     */
     ...
     *
     * @return possible object is {@link PathToIndexedFieldType }
     */
     ...
     *
     * @param value allowed object is {@link PathToIndexedFieldType }
     */
     ...
     *
     * @return possible object is {@link PathToExtendedFieldType }
     */
     ...
     *
     * @param value allowed object is {@link PathToExtendedFieldType }
     */
     ...
     *
     * @return possible object is {@link AggregateType }
     */
     ...
     *
     * @param value allowed object is {@link AggregateType }
     */
