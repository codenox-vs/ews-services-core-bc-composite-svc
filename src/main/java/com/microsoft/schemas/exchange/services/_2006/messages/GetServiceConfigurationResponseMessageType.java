...
/**
 * Java class for GetServiceConfigurationResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetServiceConfigurationResponseMessageType",
        propOrder = {"responseMessages"})
public class GetServiceConfigurationResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfServiceConfigurationResponseMessageType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfServiceConfigurationResponseMessageType }
     */
