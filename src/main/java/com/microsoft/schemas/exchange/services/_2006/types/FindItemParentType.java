...
/**
 * Java class for FindItemParentType complex type.
 *
...
@XmlType(
        name = "FindItemParentType",
        propOrder = {"items", "groups"})
public class FindItemParentType {
     ...
     *
     * @return possible object is {@link ArrayOfGroupedItemsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfGroupedItemsType }
     */
