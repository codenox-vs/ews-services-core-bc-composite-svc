...
/**
 * Java class for UMReportAudioMetricsAverageCountersType complex type.
 *
...
@XmlType(
        name = "UMReportAudioMetricsAverageCountersType",
        propOrder = {
            "nmos",
            "nmosDegradation",
            "jitter",
...
public class UMReportAudioMetricsAverageCountersType {
     ...
     *
     * @return possible object is {@link AudioMetricsAverageType }
     */
     ...
     *
     * @param value allowed object is {@link AudioMetricsAverageType }
     */
