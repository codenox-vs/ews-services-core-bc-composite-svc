...
@XmlType(
        name = "NonEmptyArrayOfMailboxQueriesType",
        propOrder = {"mailboxQuery"})
public class NonEmptyArrayOfMailboxQueriesType {
     ...
     * why there is not a <CODE>set</CODE> method for the mailboxQuery property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MailboxQueryType }
     */
