...
/**
 * Java class for ArrayOfStringArrayAttributedValuesType complex type.
 *
...
@XmlType(
        name = "ArrayOfStringArrayAttributedValuesType",
        propOrder = {"stringArrayAttributedValue"})
public class ArrayOfStringArrayAttributedValuesType {
     ...
     * why there is not a <CODE>set</CODE> method for the stringArrayAttributedValue property.
     *
