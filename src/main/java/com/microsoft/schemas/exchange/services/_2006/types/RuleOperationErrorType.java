...
/**
 * Java class for RuleOperationErrorType complex type.
 *
...
@XmlType(
        name = "RuleOperationErrorType",
        propOrder = {"operationIndex", "validationErrors"})
public class RuleOperationErrorType {
     ...
     *
     * @return possible object is {@link ArrayOfRuleValidationErrorsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfRuleValidationErrorsType }
     */
