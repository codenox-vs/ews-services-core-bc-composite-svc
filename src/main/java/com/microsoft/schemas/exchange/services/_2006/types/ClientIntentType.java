...
/**
 * Java class for ClientIntentType complex type.
 *
...
@XmlType(
        name = "ClientIntentType",
        propOrder = {"itemId", "intent", "itemVersion", "wouldRepair", "predictedAction"})
public class ClientIntentType {
     ...
     *
     * @return possible object is {@link ClientIntentMeetingInquiryActionType }
     */
     ...
     *
     * @param value allowed object is {@link ClientIntentMeetingInquiryActionType }
     */
