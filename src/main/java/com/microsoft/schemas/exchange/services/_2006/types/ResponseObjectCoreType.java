...
@XmlType(
        name = "ResponseObjectCoreType",
        propOrder = {"referenceItemId"})
@XmlSeeAlso({ResponseObjectType.class})
public abstract class ResponseObjectCoreType extends MessageType {
