...
/**
 * Java class for ReminderItemActionType complex type.
 *
...
@XmlType(
        name = "ReminderItemActionType",
        propOrder = {"actionType", "itemId", "newReminderTime"})
public class ReminderItemActionType {
     ...
     *
     * @return possible object is {@link ReminderActionType }
     */
     ...
     *
     * @param value allowed object is {@link ReminderActionType }
     */
