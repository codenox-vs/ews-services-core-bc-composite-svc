...
/**
 * Java class for DeleteUserConfigurationType complex type.
 *
...
@XmlType(
        name = "DeleteUserConfigurationType",
        propOrder = {"userConfigurationName"})
public class DeleteUserConfigurationType extends BaseRequestType {
