...
/**
 * Java class for ArrayOfAttendeeConflictData complex type.
 *
...
@XmlType(
        name = "ArrayOfAttendeeConflictData",
        propOrder = {
...
public class ArrayOfAttendeeConflictData {
    ...
    @XmlElements({
        @XmlElement(
                ...
                type = UnknownAttendeeConflictData.class,
                nillable = true),
        @XmlElement(
                name = "TooBigGroupAttendeeConflictData",
                type = TooBigGroupAttendeeConflictData.class,
                nillable = true),
        @XmlElement(
                name = "GroupAttendeeConflictData",
                type = GroupAttendeeConflictData.class,
                nillable = true),
        @XmlElement(
                name = "IndividualAttendeeConflictData",
                type = IndividualAttendeeConflictData.class,
                nillable = true)
    })
    protected List<AttendeeConflictData>
            unknownAttendeeConflictDataOrIndividualAttendeeConflictDataOrTooBigGroupAttendeeConflictData;
     ...
     * UnknownAttendeeConflictData } {@link TooBigGroupAttendeeConflictData } {@link
     * GroupAttendeeConflictData } {@link IndividualAttendeeConflictData }
     */
    public List<AttendeeConflictData>
            getUnknownAttendeeConflictDataOrIndividualAttendeeConflictDataOrTooBigGroupAttendeeConflictData() {
        if (unknownAttendeeConflictDataOrIndividualAttendeeConflictDataOrTooBigGroupAttendeeConflictData
                == null) {
            unknownAttendeeConflictDataOrIndividualAttendeeConflictDataOrTooBigGroupAttendeeConflictData =
                    new ArrayList<AttendeeConflictData>();
        }
        return this
                .unknownAttendeeConflictDataOrIndividualAttendeeConflictDataOrTooBigGroupAttendeeConflictData;
    }
