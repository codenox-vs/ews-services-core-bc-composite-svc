...
/**
 * Java class for SetTeamMailboxRequestType complex type.
 *
...
@XmlType(
        name = "SetTeamMailboxRequestType",
        propOrder = {"emailAddress", "sharePointSiteUrl", "state"})
public class SetTeamMailboxRequestType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link TeamMailboxLifecycleStateType }
     */
     ...
     *
     * @param value allowed object is {@link TeamMailboxLifecycleStateType }
     */
