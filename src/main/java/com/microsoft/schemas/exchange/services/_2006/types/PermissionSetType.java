...
@XmlType(
        name = "PermissionSetType",
        propOrder = {"permissions", "unknownEntries"})
public class PermissionSetType {
     ...
     *
     * @return possible object is {@link ArrayOfPermissionsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfPermissionsType }
     */
