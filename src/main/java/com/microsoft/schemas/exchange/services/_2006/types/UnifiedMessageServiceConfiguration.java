...
/**
 * Java class for UnifiedMessageServiceConfiguration complex type.
 *
...
@XmlType(
        name = "UnifiedMessageServiceConfiguration",
        propOrder = {"umEnabled", "playOnPhoneDialString", "playOnPhoneEnabled"})
