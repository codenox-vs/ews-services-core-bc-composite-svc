...
/**
 * Response Message for a single id conversion in the ConvertId web method. Note that the
 * AlternateId element will be missing in the case of an error.
 *
...
@XmlType(
        name = "ConvertIdResponseMessageType",
        propOrder = {"alternateId"})
public class ConvertIdResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link AlternateIdBaseType }
     */
     ...
     *
     * @param value allowed object is {@link AlternateIdBaseType }
     */
