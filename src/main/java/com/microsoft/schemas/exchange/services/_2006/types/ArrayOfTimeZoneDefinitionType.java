...
/**
 * Java class for ArrayOfTimeZoneDefinitionType complex type.
 *
...
@XmlType(
        name = "ArrayOfTimeZoneDefinitionType",
        propOrder = {"timeZoneDefinition"})
public class ArrayOfTimeZoneDefinitionType {
     ...
     * why there is not a <CODE>set</CODE> method for the timeZoneDefinition property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link TimeZoneDefinitionType }
     */
