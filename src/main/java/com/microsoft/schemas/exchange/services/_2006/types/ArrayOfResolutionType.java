...
/**
 * Java class for ArrayOfResolutionType complex type.
 *
...
@XmlType(
        name = "ArrayOfResolutionType",
        propOrder = {"resolution"})
public class ArrayOfResolutionType {
     ...
     * why there is not a <CODE>set</CODE> method for the resolution property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ResolutionType }
     */
