...
/**
 * Java class for ArrayOfGroupedItemsType complex type.
 *
...
@XmlType(
        name = "ArrayOfGroupedItemsType",
        propOrder = {"groupedItems"})
public class ArrayOfGroupedItemsType {
     ...
     * why there is not a <CODE>set</CODE> method for the groupedItems property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link GroupedItemsType }
     */
