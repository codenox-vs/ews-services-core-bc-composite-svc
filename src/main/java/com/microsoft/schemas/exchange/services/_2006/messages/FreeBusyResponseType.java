...
/**
 * Java class for FreeBusyResponseType complex type.
 *
...
@XmlType(
        name = "FreeBusyResponseType",
        propOrder = {"responseMessage", "freeBusyView"})
public class FreeBusyResponseType {
     ...
     *
     * @return possible object is {@link FreeBusyView }
     */
     ...
     *
     * @param value allowed object is {@link FreeBusyView }
     */
