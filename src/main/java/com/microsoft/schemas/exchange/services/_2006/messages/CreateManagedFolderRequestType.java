...
/**
 * Java class for CreateManagedFolderRequestType complex type.
 *
...
@XmlType(
        name = "CreateManagedFolderRequestType",
        propOrder = {"folderNames", "mailbox"})
public class CreateManagedFolderRequestType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfFolderNamesType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfFolderNamesType }
     */
