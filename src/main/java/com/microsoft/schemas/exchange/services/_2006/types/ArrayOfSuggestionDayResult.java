...
/**
 * Java class for ArrayOfSuggestionDayResult complex type.
 *
...
@XmlType(
        name = "ArrayOfSuggestionDayResult",
        propOrder = {"suggestionDayResult"})
public class ArrayOfSuggestionDayResult {
     ...
     * why there is not a <CODE>set</CODE> method for the suggestionDayResult property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link SuggestionDayResult }
     */
