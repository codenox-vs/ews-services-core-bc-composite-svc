...
/**
 * Java class for EncryptedSharedFolderDataType complex type.
 *
...
@XmlType(
        name = "EncryptedSharedFolderDataType",
        propOrder = {"token", "data"})
public class EncryptedSharedFolderDataType {
     ...
     *
     * @return possible object is {@link EncryptedDataContainerType }
     */
     ...
     *
     * @param value allowed object is {@link EncryptedDataContainerType }
     */
