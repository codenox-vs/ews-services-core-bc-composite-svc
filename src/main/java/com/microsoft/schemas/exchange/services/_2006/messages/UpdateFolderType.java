...
/**
 * Java class for UpdateFolderType complex type.
 *
...
@XmlType(
        name = "UpdateFolderType",
        propOrder = {"folderChanges"})
public class UpdateFolderType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfFolderChangesType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfFolderChangesType }
     */
