...
@XmlType(
        ...
        propOrder = {"readItems", "calendarPermissionLevel"})
public class CalendarPermissionType extends BasePermissionType {
     ...
     *
     * @return possible object is {@link CalendarPermissionLevelType }
     */
     ...
     *
     * @param value allowed object is {@link CalendarPermissionLevelType }
     */
