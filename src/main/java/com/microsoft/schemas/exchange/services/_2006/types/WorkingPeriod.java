...
/**
 * Java class for WorkingPeriod complex type.
 *
...
@XmlType(
        name = "WorkingPeriod",
        propOrder = {"dayOfWeek", "startTimeInMinutes", "endTimeInMinutes"})
public class WorkingPeriod {
     ...
     * why there is not a <CODE>set</CODE> method for the dayOfWeek property.
     *
