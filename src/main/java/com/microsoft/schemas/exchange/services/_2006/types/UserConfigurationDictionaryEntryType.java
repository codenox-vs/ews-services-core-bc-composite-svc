...
/**
 * Java class for UserConfigurationDictionaryEntryType complex type.
 *
...
@XmlType(
        name = "UserConfigurationDictionaryEntryType",
        propOrder = {"dictionaryKey", "dictionaryValue"})
public class UserConfigurationDictionaryEntryType {
     ...
     *
     * @return possible object is {@link UserConfigurationDictionaryObjectType }
     */
     ...
     *
     * @param value allowed object is {@link UserConfigurationDictionaryObjectType }
     */
