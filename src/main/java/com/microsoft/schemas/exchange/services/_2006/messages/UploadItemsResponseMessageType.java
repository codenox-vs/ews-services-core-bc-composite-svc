...
/**
 * Java class for UploadItemsResponseMessageType complex type.
 *
...
@XmlType(
        name = "UploadItemsResponseMessageType",
        propOrder = {"itemId"})
public class UploadItemsResponseMessageType extends ResponseMessageType {
