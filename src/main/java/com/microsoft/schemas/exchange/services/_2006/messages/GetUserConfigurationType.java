...
/**
 * Java class for GetUserConfigurationType complex type.
 *
...
@XmlType(
        name = "GetUserConfigurationType",
        propOrder = {"userConfigurationName", "userConfigurationProperties"})
public class GetUserConfigurationType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link UserConfigurationNameType }
     */
     ...
     *
     * @param value allowed object is {@link UserConfigurationNameType }
     */
     ...
     * why there is not a <CODE>set</CODE> method for the userConfigurationProperties property.
     *
