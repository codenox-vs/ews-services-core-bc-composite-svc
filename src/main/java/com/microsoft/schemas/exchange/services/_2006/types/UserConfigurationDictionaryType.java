...
/**
 * Java class for UserConfigurationDictionaryType complex type.
 *
...
@XmlType(
        name = "UserConfigurationDictionaryType",
        propOrder = {"dictionaryEntry"})
public class UserConfigurationDictionaryType {
     ...
     * why there is not a <CODE>set</CODE> method for the dictionaryEntry property.
     *
