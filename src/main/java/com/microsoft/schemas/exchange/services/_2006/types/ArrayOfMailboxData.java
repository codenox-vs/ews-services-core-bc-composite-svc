...
/**
 * Java class for ArrayOfMailboxData complex type.
 *
...
@XmlType(
        name = "ArrayOfMailboxData",
        propOrder = {"mailboxData"})
public class ArrayOfMailboxData {
     ...
     * why there is not a <CODE>set</CODE> method for the mailboxData property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MailboxData }
     */
