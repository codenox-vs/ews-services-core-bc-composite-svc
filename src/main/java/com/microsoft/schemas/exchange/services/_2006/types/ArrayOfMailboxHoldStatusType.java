...
@XmlType(
        name = "ArrayOfMailboxHoldStatusType",
        propOrder = {"mailboxHoldStatus"})
public class ArrayOfMailboxHoldStatusType {
     ...
     * why there is not a <CODE>set</CODE> method for the mailboxHoldStatus property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MailboxHoldStatusType }
     */
