...
/**
 * Java class for ResolveNamesType complex type.
 *
...
@XmlType(
        name = "ResolveNamesType",
        propOrder = {"parentFolderIds", "unresolvedEntry"})
public class ResolveNamesType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link ResolveNamesSearchScopeType }
     */
     ...
     *
     * @param value allowed object is {@link ResolveNamesSearchScopeType }
     */
