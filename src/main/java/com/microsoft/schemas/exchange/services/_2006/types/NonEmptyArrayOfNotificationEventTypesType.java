...
/**
 * Java class for NonEmptyArrayOfNotificationEventTypesType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfNotificationEventTypesType",
        propOrder = {"eventType"})
public class NonEmptyArrayOfNotificationEventTypesType {
     ...
     * why there is not a <CODE>set</CODE> method for the eventType property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link NotificationEventTypeType
     * }
     */
