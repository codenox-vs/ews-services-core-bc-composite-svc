...
/**
 * Java class for ResolveNamesResponseMessageType complex type.
 *
...
@XmlType(
        name = "ResolveNamesResponseMessageType",
        propOrder = {"resolutionSet"})
public class ResolveNamesResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfResolutionType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfResolutionType }
     */
