...
@XmlType(
        name = "PhysicalAddressDictionaryEntryType",
        propOrder = {"street", "city", "state", "countryOrRegion", "postalCode"})
public class PhysicalAddressDictionaryEntryType {
     ...
     *
     * @return possible object is {@link PhysicalAddressKeyType }
     */
     ...
     *
     * @param value allowed object is {@link PhysicalAddressKeyType }
     */
