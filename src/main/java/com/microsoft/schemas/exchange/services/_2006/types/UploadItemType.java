...
/**
 * Java class for UploadItemType complex type.
 *
...
@XmlType(
        name = "UploadItemType",
        propOrder = {"parentFolderId", "itemId", "data"})
public class UploadItemType {
     ...
     *
     * @return possible object is {@link CreateActionType }
     */
     ...
     *
     * @param value allowed object is {@link CreateActionType }
     */
