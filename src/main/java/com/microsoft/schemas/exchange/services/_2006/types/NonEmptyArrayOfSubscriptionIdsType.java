...
/**
 * Java class for NonEmptyArrayOfSubscriptionIdsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfSubscriptionIdsType",
        propOrder = {"subscriptionId"})
public class NonEmptyArrayOfSubscriptionIdsType {
     ...
     * why there is not a <CODE>set</CODE> method for the subscriptionId property.
     *
