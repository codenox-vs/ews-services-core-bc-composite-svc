...
/**
 * Java class for NonEmptyArrayOfExtendedFieldURIsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfExtendedFieldURIsType",
        propOrder = {"extendedFieldURI"})
public class NonEmptyArrayOfExtendedFieldURIsType {
     ...
     * why there is not a <CODE>set</CODE> method for the extendedFieldURI property.
     *
