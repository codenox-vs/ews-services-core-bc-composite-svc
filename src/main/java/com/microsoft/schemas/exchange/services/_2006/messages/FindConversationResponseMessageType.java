...
/**
 * Java class for FindConversationResponseMessageType complex type.
 *
...
@XmlType(
        name = "FindConversationResponseMessageType",
        propOrder = {
            "conversations",
            "highlightTerms",
...
public class FindConversationResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfConversationsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfConversationsType }
     */
