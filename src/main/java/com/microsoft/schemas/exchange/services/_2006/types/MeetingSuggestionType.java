...
/**
 * Java class for MeetingSuggestionType complex type.
 *
...
@XmlType(
        name = "MeetingSuggestionType",
        propOrder = {"attendees", "location", "subject", "meetingString", "startTime", "endTime"})
public class MeetingSuggestionType extends EntityType {
     ...
     *
     * @return possible object is {@link ArrayOfEmailUsersType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfEmailUsersType }
     */
