...
/**
 * Java class for GetDelegateResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetDelegateResponseMessageType",
        propOrder = {"deliverMeetingRequests"})
public class GetDelegateResponseMessageType extends BaseDelegateResponseMessageType {
