...
/**
 * Java class for ArrayOfMeetingSuggestionsType complex type.
 *
...
@XmlType(
        name = "ArrayOfMeetingSuggestionsType",
        propOrder = {"meetingSuggestion"})
public class ArrayOfMeetingSuggestionsType {
     ...
     * why there is not a <CODE>set</CODE> method for the meetingSuggestion property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MeetingSuggestionType }
     */
