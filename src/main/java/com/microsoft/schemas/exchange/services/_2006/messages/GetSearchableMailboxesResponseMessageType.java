...
import com.microsoft.schemas.exchange.services._2006.types.ArrayOfFailedSearchMailboxesType;
import com.microsoft.schemas.exchange.services._2006.types.ArrayOfSearchableMailboxesType;
...
@XmlType(
        name = "GetSearchableMailboxesResponseMessageType",
        propOrder = {"searchableMailboxes", "failedMailboxes"})
public class GetSearchableMailboxesResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfSearchableMailboxesType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfSearchableMailboxesType }
     */
