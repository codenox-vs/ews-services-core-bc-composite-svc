...
/**
 * Java class for NonEmptyArrayOfRequestAttachmentIdsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfRequestAttachmentIdsType",
        propOrder = {"attachmentId"})
public class NonEmptyArrayOfRequestAttachmentIdsType {
     ...
     * why there is not a <CODE>set</CODE> method for the attachmentId property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link RequestAttachmentIdType }
     */
