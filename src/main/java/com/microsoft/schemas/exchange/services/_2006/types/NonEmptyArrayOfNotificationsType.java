...
/**
 * Java class for NonEmptyArrayOfNotificationsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfNotificationsType",
...
public class NonEmptyArrayOfNotificationsType {
     ...
     * why there is not a <CODE>set</CODE> method for the notification property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link NotificationType }
     */
