 ...
 * combinations. Note that all occurances require the PropertyType attribute. 1.
 * (DistinguishedPropertySetId || PropertySetId) + (PropertyName || Property Id) 2. PropertyTag
 *
...
public class PathToExtendedFieldType extends BasePathToElementType {
     ...
     *
     * @return possible object is {@link DistinguishedPropertySetType }
     */
     ...
     *
     * @param value allowed object is {@link DistinguishedPropertySetType }
     */
     ...
     *
     * @return possible object is {@link MapiPropertyTypeType }
     */
     ...
     *
     * @param value allowed object is {@link MapiPropertyTypeType }
     */
