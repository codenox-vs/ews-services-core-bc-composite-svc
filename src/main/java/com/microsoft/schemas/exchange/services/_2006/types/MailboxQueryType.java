...
@XmlType(
        name = "MailboxQueryType",
        propOrder = {"query", "mailboxSearchScopes"})
public class MailboxQueryType {
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfMailboxSearchScopesType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfMailboxSearchScopesType }
     */
