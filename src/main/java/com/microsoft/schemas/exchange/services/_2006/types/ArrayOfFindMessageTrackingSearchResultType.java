...
/**
 * Java class for ArrayOfFindMessageTrackingSearchResultType complex type.
 *
...
@XmlType(
        name = "ArrayOfFindMessageTrackingSearchResultType",
        propOrder = {"messageTrackingSearchResult"})
public class ArrayOfFindMessageTrackingSearchResultType {
     ...
     * why there is not a <CODE>set</CODE> method for the messageTrackingSearchResult property.
     *
