...
/**
 * Represents an extended property instance (both its path identifier along with its associated
 * value).
 *
...
@XmlType(
        ...
        propOrder = {"extendedFieldURI", "value", "values"})
public class ExtendedPropertyType {
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfPropertyValuesType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfPropertyValuesType }
     */
