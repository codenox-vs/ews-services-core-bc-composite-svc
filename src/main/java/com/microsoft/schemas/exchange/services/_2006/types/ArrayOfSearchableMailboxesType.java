...
@XmlType(
        name = "ArrayOfSearchableMailboxesType",
        propOrder = {"searchableMailbox"})
public class ArrayOfSearchableMailboxesType {
     ...
     * why there is not a <CODE>set</CODE> method for the searchableMailbox property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link SearchableMailboxType }
     */
