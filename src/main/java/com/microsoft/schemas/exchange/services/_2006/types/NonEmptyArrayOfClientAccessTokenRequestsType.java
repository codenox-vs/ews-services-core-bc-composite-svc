...
/**
 * Java class for NonEmptyArrayOfClientAccessTokenRequestsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfClientAccessTokenRequestsType",
        propOrder = {"tokenRequest"})
public class NonEmptyArrayOfClientAccessTokenRequestsType {
     ...
     * why there is not a <CODE>set</CODE> method for the tokenRequest property.
     *
