...
/**
 * Java class for NumberedRecurrenceRangeType complex type.
 *
...
@XmlType(
        name = "NumberedRecurrenceRangeType",
        propOrder = {"numberOfOccurrences"})
public class NumberedRecurrenceRangeType extends RecurrenceRangeBaseType {
