...
@XmlType(
        name = "NonIndexableItemDetailResultType",
        propOrder = {"items", "failedMailboxes"})
public class NonIndexableItemDetailResultType {
     ...
     *
     * @return possible object is {@link ArrayOfNonIndexableItemDetailsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfNonIndexableItemDetailsType }
     */
