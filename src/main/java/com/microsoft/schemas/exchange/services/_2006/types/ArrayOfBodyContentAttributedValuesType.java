...
/**
 * Java class for ArrayOfBodyContentAttributedValuesType complex type.
 *
...
@XmlType(
        name = "ArrayOfBodyContentAttributedValuesType",
        propOrder = {"bodyContentAttributedValue"})
public class ArrayOfBodyContentAttributedValuesType {
     ...
     * why there is not a <CODE>set</CODE> method for the bodyContentAttributedValue property.
     *
