...
/**
 * Java class for NonEmptyArrayOfFieldOrdersType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfFieldOrdersType",
        propOrder = {"fieldOrder"})
public class NonEmptyArrayOfFieldOrdersType {
     ...
     * why there is not a <CODE>set</CODE> method for the fieldOrder property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link FieldOrderType }
     */
