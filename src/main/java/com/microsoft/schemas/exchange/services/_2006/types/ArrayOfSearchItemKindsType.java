...
@XmlType(
        name = "ArrayOfSearchItemKindsType",
        propOrder = {"searchItemKind"})
public class ArrayOfSearchItemKindsType {
     ...
     * why there is not a <CODE>set</CODE> method for the searchItemKind property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link SearchItemKindType }
     */
