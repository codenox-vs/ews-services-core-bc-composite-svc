...
/**
 * Java class for ArrayOfFreeBusyResponse complex type.
 *
...
@XmlType(
        name = "ArrayOfFreeBusyResponse",
        propOrder = {"freeBusyResponse"})
public class ArrayOfFreeBusyResponse {
     ...
     * why there is not a <CODE>set</CODE> method for the freeBusyResponse property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link FreeBusyResponseType }
     */
