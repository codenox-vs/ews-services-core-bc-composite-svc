...
/**
 * Java class for ArrayOfTransitionsGroupsType complex type.
 *
...
@XmlType(
        name = "ArrayOfTransitionsGroupsType",
        propOrder = {"transitionsGroup"})
public class ArrayOfTransitionsGroupsType {
     ...
     * why there is not a <CODE>set</CODE> method for the transitionsGroup property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ArrayOfTransitionsType }
     */
