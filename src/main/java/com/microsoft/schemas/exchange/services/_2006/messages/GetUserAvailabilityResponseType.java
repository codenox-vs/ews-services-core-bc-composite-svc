...
/**
 * Java class for GetUserAvailabilityResponseType complex type.
 *
...
@XmlType(
        name = "GetUserAvailabilityResponseType",
        propOrder = {"freeBusyResponseArray", "suggestionsResponse"})
public class GetUserAvailabilityResponseType {
     ...
     *
     * @return possible object is {@link ArrayOfFreeBusyResponse }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfFreeBusyResponse }
     */
     ...
     *
     * @return possible object is {@link SuggestionsResponseType }
     */
     ...
     *
     * @param value allowed object is {@link SuggestionsResponseType }
     */
