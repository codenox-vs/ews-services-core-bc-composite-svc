...
/**
 * Java class for AddImGroupResponseMessageType complex type.
 *
...
@XmlType(
        name = "AddImGroupResponseMessageType",
        propOrder = {"imGroup"})
public class AddImGroupResponseMessageType extends ResponseMessageType {
