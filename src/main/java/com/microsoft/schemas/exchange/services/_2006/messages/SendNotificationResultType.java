...
/**
 * Java class for SendNotificationResultType complex type.
 *
...
@XmlType(
        name = "SendNotificationResultType",
        propOrder = {"subscriptionStatus"})
public class SendNotificationResultType {
     ...
     *
     * @return possible object is {@link SubscriptionStatusType }
     */
     ...
     *
     * @param value allowed object is {@link SubscriptionStatusType }
     */
