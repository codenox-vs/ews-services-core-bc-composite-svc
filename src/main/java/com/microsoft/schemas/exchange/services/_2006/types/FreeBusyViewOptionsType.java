...
/**
 * Java class for FreeBusyViewOptionsType complex type.
 *
...
@XmlType(
        name = "FreeBusyViewOptionsType",
        propOrder = {"timeWindow", "mergedFreeBusyIntervalInMinutes", "requestedView"})
public class FreeBusyViewOptionsType {
     ...
     * why there is not a <CODE>set</CODE> method for the requestedView property.
     *
