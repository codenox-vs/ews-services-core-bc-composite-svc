...
/**
 * Java class for PlayOnPhoneResponseMessageType complex type.
 *
...
@XmlType(
        name = "PlayOnPhoneResponseMessageType",
        propOrder = {"phoneCallId"})
public class PlayOnPhoneResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link PhoneCallIdType }
     */
     ...
     *
     * @param value allowed object is {@link PhoneCallIdType }
     */
