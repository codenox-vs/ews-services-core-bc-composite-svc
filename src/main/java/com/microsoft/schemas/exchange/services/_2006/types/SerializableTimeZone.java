...
/**
 * Java class for SerializableTimeZone complex type.
 *
...
@XmlType(
        name = "SerializableTimeZone",
        propOrder = {"bias", "standardTime", "daylightTime"})
public class SerializableTimeZone {
     ...
     *
     * @return possible object is {@link SerializableTimeZoneTime }
     */
     ...
     *
     * @param value allowed object is {@link SerializableTimeZoneTime }
     */
