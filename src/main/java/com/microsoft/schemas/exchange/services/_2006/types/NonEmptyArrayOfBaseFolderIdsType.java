...
/**
 * Java class for NonEmptyArrayOfBaseFolderIdsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfBaseFolderIdsType",
        propOrder = {"folderIdOrDistinguishedFolderId"})
public class NonEmptyArrayOfBaseFolderIdsType {
     ...
     * why there is not a <CODE>set</CODE> method for the folderIdOrDistinguishedFolderId property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link DistinguishedFolderIdType
     * } {@link FolderIdType }
     */
