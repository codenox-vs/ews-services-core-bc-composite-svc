...
/**
 * Java class for ProtectionRulesServiceConfiguration complex type.
 *
...
@XmlType(
        name = "ProtectionRulesServiceConfiguration",
        propOrder = {"rules", "internalDomains"})
public class ProtectionRulesServiceConfiguration extends ServiceConfiguration {
     ...
     *
     * @return possible object is {@link ArrayOfProtectionRulesType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfProtectionRulesType }
     */
