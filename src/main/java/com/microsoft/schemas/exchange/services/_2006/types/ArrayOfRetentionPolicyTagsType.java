...
@XmlType(
        name = "ArrayOfRetentionPolicyTagsType",
        propOrder = {"retentionPolicyTag"})
public class ArrayOfRetentionPolicyTagsType {
     ...
     * why there is not a <CODE>set</CODE> method for the retentionPolicyTag property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link RetentionPolicyTagType }
     */
