...
/**
 * Represents a single validation error on a particular rule property value, predicate property
 * value or action property value
 *
...
@XmlType(
        name = "RuleValidationErrorType",
        propOrder = {"fieldURI", "errorCode", "errorMessage", "fieldValue"})
public class RuleValidationErrorType {
     ...
     *
     * @return possible object is {@link RuleFieldURIType }
     */
     ...
     *
     * @param value allowed object is {@link RuleFieldURIType }
     */
     ...
     *
     * @return possible object is {@link RuleValidationErrorCodeType }
     */
     ...
     *
     * @param value allowed object is {@link RuleValidationErrorCodeType }
     */
