...
/**
 * Java class for ArrayOfSmtpAddressType complex type.
 *
...
@XmlType(
        name = "ArrayOfSmtpAddressType",
        propOrder = {"smtpAddress"})
public class ArrayOfSmtpAddressType {
     ...
     * why there is not a <CODE>set</CODE> method for the smtpAddress property.
     *
