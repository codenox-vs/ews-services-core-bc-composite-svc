...
@XmlType(
        name = "ArrayOfNonIndexableItemDetailsType",
        propOrder = {"nonIndexableItemDetail"})
public class ArrayOfNonIndexableItemDetailsType {
     ...
     * why there is not a <CODE>set</CODE> method for the nonIndexableItemDetail property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link NonIndexableItemDetailType
     * }
     */
