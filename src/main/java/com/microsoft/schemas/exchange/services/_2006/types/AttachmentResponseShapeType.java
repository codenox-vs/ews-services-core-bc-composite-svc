...
/**
 * Java class for AttachmentResponseShapeType complex type.
 *
...
@XmlType(
        name = "AttachmentResponseShapeType",
        propOrder = {"includeMimeContent", "bodyType", "filterHtmlContent", "additionalProperties"})
public class AttachmentResponseShapeType {
     ...
     *
     * @return possible object is {@link BodyTypeResponseType }
     */
     ...
     *
     * @param value allowed object is {@link BodyTypeResponseType }
     */
