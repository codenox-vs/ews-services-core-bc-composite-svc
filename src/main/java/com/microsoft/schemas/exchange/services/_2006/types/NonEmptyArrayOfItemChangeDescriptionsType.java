...
/**
 * Java class for NonEmptyArrayOfItemChangeDescriptionsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfItemChangeDescriptionsType",
        propOrder = {"appendToItemFieldOrSetItemFieldOrDeleteItemField"})
public class NonEmptyArrayOfItemChangeDescriptionsType {
     ...
     * appendToItemFieldOrSetItemFieldOrDeleteItemField property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link DeleteItemFieldType }
     * {@link AppendToItemFieldType } {@link SetItemFieldType }
     */
    public List<ItemChangeDescriptionType> getAppendToItemFieldOrSetItemFieldOrDeleteItemField() {
        if (appendToItemFieldOrSetItemFieldOrDeleteItemField == null) {
            appendToItemFieldOrSetItemFieldOrDeleteItemField =
                    new ArrayList<ItemChangeDescriptionType>();
        }
