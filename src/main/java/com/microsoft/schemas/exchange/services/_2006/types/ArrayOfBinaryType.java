...
/**
 * Java class for ArrayOfBinaryType complex type.
 *
...
@XmlType(
        name = "ArrayOfBinaryType",
        propOrder = {"base64Binary"})
public class ArrayOfBinaryType {
     ...
     * why there is not a <CODE>set</CODE> method for the base64Binary property.
     *
