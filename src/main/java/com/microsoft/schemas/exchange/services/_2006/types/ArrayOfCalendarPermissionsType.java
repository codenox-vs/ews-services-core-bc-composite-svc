...
/**
 * Java class for ArrayOfCalendarPermissionsType complex type.
 *
...
@XmlType(
        name = "ArrayOfCalendarPermissionsType",
        propOrder = {"calendarPermission"})
public class ArrayOfCalendarPermissionsType {
     ...
     * why there is not a <CODE>set</CODE> method for the calendarPermission property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link CalendarPermissionType }
     */
