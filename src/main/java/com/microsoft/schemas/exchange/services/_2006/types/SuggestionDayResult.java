...
/**
 * Java class for SuggestionDayResult complex type.
 *
...
@XmlType(
        ...
        propOrder = {"date", "dayQuality", "suggestionArray"})
public class SuggestionDayResult {
     ...
     *
     * @return possible object is {@link ArrayOfSuggestion }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfSuggestion }
     */
