...
/**
 * Java class for GetSharingMetadataResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetSharingMetadataResponseMessageType",
        propOrder = {"encryptedSharedFolderDataCollection", "invalidRecipients"})
public class GetSharingMetadataResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfEncryptedSharedFolderDataType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfEncryptedSharedFolderDataType }
     */
     ...
     *
     * @return possible object is {@link ArrayOfInvalidRecipientsType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfInvalidRecipientsType }
     */
