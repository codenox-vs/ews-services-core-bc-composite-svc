...
/**
 * Java class for GetClientExtensionUserParametersType complex type.
 *
...
@XmlType(
        name = "GetClientExtensionUserParametersType",
        propOrder = {"userEnabledExtensions", "userDisabledExtensions"})
