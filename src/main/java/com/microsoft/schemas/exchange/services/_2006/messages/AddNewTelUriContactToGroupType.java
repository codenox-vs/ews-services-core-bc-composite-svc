...
/**
 * Java class for AddNewTelUriContactToGroupType complex type.
 *
...
@XmlType(
        name = "AddNewTelUriContactToGroupType",
        propOrder = {"telUriAddress", "imContactSipUriAddress", "imTelephoneNumber", "groupId"})
