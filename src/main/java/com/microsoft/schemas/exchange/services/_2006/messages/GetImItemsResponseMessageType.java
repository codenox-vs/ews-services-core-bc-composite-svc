...
/**
 * Java class for GetImItemsResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetImItemsResponseMessageType",
        propOrder = {"imItemList"})
public class GetImItemsResponseMessageType extends ResponseMessageType {
