...
@XmlSeeAlso({TentativelyAcceptItemType.class, DeclineItemType.class, AcceptItemType.class})
public class WellKnownResponseObjectType extends ResponseObjectType {}
