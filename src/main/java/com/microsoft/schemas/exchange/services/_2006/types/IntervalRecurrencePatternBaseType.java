...
/**
 * Java class for IntervalRecurrencePatternBaseType complex type.
 *
...
@XmlType(
        name = "IntervalRecurrencePatternBaseType",
        propOrder = {"interval"})
@XmlSeeAlso({
...
public abstract class IntervalRecurrencePatternBaseType extends RecurrencePatternBaseType {
