...
/**
 * Java class for GetUMPinResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetUMPinResponseMessageType",
        propOrder = {"pinInfo"})
public class GetUMPinResponseMessageType extends ResponseMessageType {
