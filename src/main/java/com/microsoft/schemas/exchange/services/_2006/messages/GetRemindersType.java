...
/**
 * Java class for GetRemindersType complex type.
 *
...
@XmlType(
        name = "GetRemindersType",
        propOrder = {"beginTime", "endTime", "maxItems", "reminderType"})
public class GetRemindersType extends BaseRequestType {
