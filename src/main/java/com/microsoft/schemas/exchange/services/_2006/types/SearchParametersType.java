...
/**
 * Java class for SearchParametersType complex type.
 *
...
@XmlType(
        name = "SearchParametersType",
        propOrder = {"restriction", "baseFolderIds"})
public class SearchParametersType {
     ...
     *
     * @return possible object is {@link SearchFolderTraversalType }
     */
     ...
     *
     * @param value allowed object is {@link SearchFolderTraversalType }
     */
