...
/**
 * Java class for GetSharingFolderType complex type.
 *
...
@XmlType(
        name = "GetSharingFolderType",
        propOrder = {"smtpAddress", "dataType", "sharedFolderId"})
public class GetSharingFolderType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link SharingDataType }
     */
     ...
     *
     * @param value allowed object is {@link SharingDataType }
     */
