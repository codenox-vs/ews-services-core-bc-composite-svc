...
/**
 * Java class for NonEmptyArrayOfPathsToElementType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfPathsToElementType",
        propOrder = {"path"})
public class NonEmptyArrayOfPathsToElementType {
     ...
     * why there is not a <CODE>set</CODE> method for the path property.
     *
     ...
     * <}{@link PathToUnindexedFieldType }{@code >} {@link JAXBElement }{@code <}{@link
     * PathToIndexedFieldType }{@code >} {@link JAXBElement }{@code <}{@link BasePathToElementType
     * }{@code >} {@link JAXBElement }{@code <}{@link PathToExtendedFieldType }{@code >}
     */
