...
/**
 * Java class for ArrayOfConversationNodesType complex type.
 *
...
@XmlType(
        name = "ArrayOfConversationNodesType",
        propOrder = {"conversationNode"})
public class ArrayOfConversationNodesType {
     ...
     * why there is not a <CODE>set</CODE> method for the conversationNode property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ConversationNodeType }
     */
