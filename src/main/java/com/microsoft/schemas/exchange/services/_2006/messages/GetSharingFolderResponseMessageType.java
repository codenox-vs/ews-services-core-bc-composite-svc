...
/**
 * Java class for GetSharingFolderResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetSharingFolderResponseMessageType",
        propOrder = {"sharingFolderId"})
public class GetSharingFolderResponseMessageType extends ResponseMessageType {
