...
/**
 * Java class for GetPasswordExpirationDateResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetPasswordExpirationDateResponseMessageType",
        propOrder = {"passwordExpirationDate"})
public class GetPasswordExpirationDateResponseMessageType extends ResponseMessageType {
