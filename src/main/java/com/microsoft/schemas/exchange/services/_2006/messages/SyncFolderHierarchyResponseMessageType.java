...
/**
 * Java class for SyncFolderHierarchyResponseMessageType complex type.
 *
...
@XmlType(
        name = "SyncFolderHierarchyResponseMessageType",
        propOrder = {"syncState", "includesLastFolderInRange", "changes"})
public class SyncFolderHierarchyResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link SyncFolderHierarchyChangesType }
     */
     ...
     *
     * @param value allowed object is {@link SyncFolderHierarchyChangesType }
     */
