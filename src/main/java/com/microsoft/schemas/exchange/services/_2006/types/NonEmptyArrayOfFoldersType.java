...
/**
 * Java class for NonEmptyArrayOfFoldersType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfFoldersType",
        propOrder = {"folderOrCalendarFolderOrContactsFolder"})
public class NonEmptyArrayOfFoldersType {
     ...
     * why there is not a <CODE>set</CODE> method for the folderOrCalendarFolderOrContactsFolder
     * property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link TasksFolderType } {@link
     * ContactsFolderType } {@link FolderType } {@link CalendarFolderType } {@link SearchFolderType
     * }
     */
