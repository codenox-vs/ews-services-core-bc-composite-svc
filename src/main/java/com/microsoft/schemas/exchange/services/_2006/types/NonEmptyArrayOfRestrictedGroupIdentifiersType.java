...
/**
 * Java class for NonEmptyArrayOfRestrictedGroupIdentifiersType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfRestrictedGroupIdentifiersType",
        propOrder = {"restrictedGroupIdentifier"})
public class NonEmptyArrayOfRestrictedGroupIdentifiersType {
     ...
     * why there is not a <CODE>set</CODE> method for the restrictedGroupIdentifier property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link SidAndAttributesType }
     */
