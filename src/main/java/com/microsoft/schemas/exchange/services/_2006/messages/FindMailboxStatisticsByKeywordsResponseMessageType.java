...
@XmlType(
        name = "FindMailboxStatisticsByKeywordsResponseMessageType",
        propOrder = {"mailboxStatisticsSearchResult"})
public class FindMailboxStatisticsByKeywordsResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link MailboxStatisticsSearchResultType }
     */
     ...
     *
     * @param value allowed object is {@link MailboxStatisticsSearchResultType }
     */
