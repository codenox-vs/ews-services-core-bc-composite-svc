...
/**
 * Java class for RelativeYearlyRecurrencePatternType complex type.
 *
...
@XmlType(
        name = "RelativeYearlyRecurrencePatternType",
        propOrder = {"daysOfWeek", "dayOfWeekIndex", "month"})
public class RelativeYearlyRecurrencePatternType extends RecurrencePatternBaseType {
     ...
     *
     * @return possible object is {@link MonthNamesType }
     */
     ...
     *
     * @param value allowed object is {@link MonthNamesType }
     */
