...
/**
 * Java class for ArrayOfPhoneNumberAttributedValuesType complex type.
 *
...
@XmlType(
        name = "ArrayOfPhoneNumberAttributedValuesType",
        propOrder = {"phoneNumberAttributedValue"})
public class ArrayOfPhoneNumberAttributedValuesType {
     ...
     * why there is not a <CODE>set</CODE> method for the phoneNumberAttributedValue property.
     *
