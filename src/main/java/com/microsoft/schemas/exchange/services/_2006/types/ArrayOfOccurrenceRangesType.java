...
/**
 * Java class for ArrayOfOccurrenceRangesType complex type.
 *
...
@XmlType(
        name = "ArrayOfOccurrenceRangesType",
        propOrder = {"range"})
public class ArrayOfOccurrenceRangesType {
     ...
     * why there is not a <CODE>set</CODE> method for the range property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link OccurrencesRangeType }
     */
