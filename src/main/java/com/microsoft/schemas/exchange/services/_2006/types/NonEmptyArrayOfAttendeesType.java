...
/**
 * Java class for NonEmptyArrayOfAttendeesType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfAttendeesType",
        propOrder = {"attendee"})
public class NonEmptyArrayOfAttendeesType {
     ...
     * why there is not a <CODE>set</CODE> method for the attendee property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link AttendeeType }
     */
