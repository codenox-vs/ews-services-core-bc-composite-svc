...
/**
 * Java class for ArrayOfTransitionsType complex type.
 *
...
@XmlType(
        name = "ArrayOfTransitionsType",
        propOrder = {"transition"})
public class ArrayOfTransitionsType {
     ...
     * why there is not a <CODE>set</CODE> method for the transition property.
     *
     ...
     * <}{@link RecurringDayTransitionType }{@code >} {@link JAXBElement }{@code <}{@link
     * TransitionType }{@code >} {@link JAXBElement }{@code <}{@link RecurringDateTransitionType
     * }{@code >} {@link JAXBElement }{@code <}{@link AbsoluteDateTransitionType }{@code >}
     */
