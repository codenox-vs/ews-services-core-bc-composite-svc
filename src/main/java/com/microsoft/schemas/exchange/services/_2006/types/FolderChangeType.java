...
/**
 * Java class for FolderChangeType complex type.
 *
...
@XmlType(
        name = "FolderChangeType",
        propOrder = {"folderId", "distinguishedFolderId", "updates"})
public class FolderChangeType {
     ...
     *
     * @return possible object is {@link DistinguishedFolderIdType }
     */
     ...
     *
     * @param value allowed object is {@link DistinguishedFolderIdType }
     */
     ...
     *
     * @return possible object is {@link NonEmptyArrayOfFolderChangeDescriptionsType }
     */
     ...
     *
     * @param value allowed object is {@link NonEmptyArrayOfFolderChangeDescriptionsType }
     */
