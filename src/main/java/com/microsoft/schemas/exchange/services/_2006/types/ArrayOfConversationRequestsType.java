...
/**
 * Java class for ArrayOfConversationRequestsType complex type.
 *
...
@XmlType(
        name = "ArrayOfConversationRequestsType",
...
public class ArrayOfConversationRequestsType {
     ...
     * why there is not a <CODE>set</CODE> method for the conversation property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ConversationRequestType }
     */
