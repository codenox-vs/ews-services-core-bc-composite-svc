...
/**
 * Allows consumers to access standard groupings for FindItem queries. This is in contrast to the
 * arbitrary (custom) groupings available via the t:GroupByType
 *
...
@XmlType(
        name = "DistinguishedGroupByType",
        propOrder = {"standardGroupBy"})
public class DistinguishedGroupByType extends BaseGroupByType {
     ...
     *
     * @return possible object is {@link StandardGroupByType }
     */
     ...
     *
     * @param value allowed object is {@link StandardGroupByType }
     */
