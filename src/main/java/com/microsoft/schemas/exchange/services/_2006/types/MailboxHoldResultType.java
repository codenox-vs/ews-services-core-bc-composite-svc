...
@XmlType(
        name = "MailboxHoldResultType",
        propOrder = {"holdId", "query", "mailboxHoldStatuses"})
public class MailboxHoldResultType {
     ...
     *
     * @return possible object is {@link ArrayOfMailboxHoldStatusType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfMailboxHoldStatusType }
     */
