...
/**
 * Java class for GetSharingMetadataType complex type.
 *
...
@XmlType(
        name = "GetSharingMetadataType",
        propOrder = {"idOfFolderToShare", "senderSmtpAddress", "recipients"})
public class GetSharingMetadataType extends BaseRequestType {
