...
/**
 * Java class for GetMailTipsResponseMessageType complex type.
 *
...
@XmlType(
        name = "GetMailTipsResponseMessageType",
        propOrder = {"responseMessages"})
public class GetMailTipsResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link ArrayOfMailTipsResponseMessageType }
     */
     ...
     *
     * @param value allowed object is {@link ArrayOfMailTipsResponseMessageType }
     */
