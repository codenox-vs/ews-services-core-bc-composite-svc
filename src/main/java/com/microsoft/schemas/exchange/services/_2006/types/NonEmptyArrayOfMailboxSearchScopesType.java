...
@XmlType(
        name = "NonEmptyArrayOfMailboxSearchScopesType",
        propOrder = {"mailboxSearchScope"})
public class NonEmptyArrayOfMailboxSearchScopesType {
     ...
     * why there is not a <CODE>set</CODE> method for the mailboxSearchScope property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link MailboxSearchScopeType }
     */
