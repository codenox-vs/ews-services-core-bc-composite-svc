...
/**
 * Java class for TargetFolderIdType complex type.
 *
...
@XmlType(
        name = "TargetFolderIdType",
        propOrder = {"folderId", "distinguishedFolderId", "addressListId"})
...
public class TargetFolderIdType {
     ...
     *
     * @return possible object is {@link AddressListIdType }
     */
     ...
     *
     * @param value allowed object is {@link AddressListIdType }
     */
