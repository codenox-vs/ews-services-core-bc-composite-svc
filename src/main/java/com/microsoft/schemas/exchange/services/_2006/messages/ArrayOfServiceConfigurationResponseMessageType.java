...
/**
 * Java class for ArrayOfServiceConfigurationResponseMessageType complex type.
 *
...
@XmlType(
        name = "ArrayOfServiceConfigurationResponseMessageType",
        propOrder = {"serviceConfigurationResponseMessageType"})
public class ArrayOfServiceConfigurationResponseMessageType {
     ...
     * why there is not a <CODE>set</CODE> method for the serviceConfigurationResponseMessageType
     * property.
     *
     ...
     */
    public List<ServiceConfigurationResponseMessageType>
            getServiceConfigurationResponseMessageType() {
        if (serviceConfigurationResponseMessageType == null) {
            serviceConfigurationResponseMessageType =
                    new ArrayList<ServiceConfigurationResponseMessageType>();
        }
