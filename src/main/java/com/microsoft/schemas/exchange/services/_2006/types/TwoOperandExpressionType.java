...
/**
 * Java class for TwoOperandExpressionType complex type.
 *
...
@XmlType(
        name = "TwoOperandExpressionType",
        propOrder = {"path", "fieldURIOrConstant"})
@XmlSeeAlso({
...
public abstract class TwoOperandExpressionType extends SearchExpressionType {
     ...
     *
     * @return possible object is {@link FieldURIOrConstantType }
     */
     ...
     *
     * @param value allowed object is {@link FieldURIOrConstantType }
     */
