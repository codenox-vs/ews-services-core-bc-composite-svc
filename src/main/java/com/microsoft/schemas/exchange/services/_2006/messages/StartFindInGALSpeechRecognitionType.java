...
/**
 * Java class for StartFindInGALSpeechRecognitionType complex type.
 *
...
@XmlType(
        name = "StartFindInGALSpeechRecognitionType",
        propOrder = {"culture", "timeZone", "userObjectGuid", "tenantGuid"})
