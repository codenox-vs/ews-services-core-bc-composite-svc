...
/**
 * Java class for ArrayOfInvalidRecipientsType complex type.
 *
...
@XmlType(
        name = "ArrayOfInvalidRecipientsType",
        propOrder = {"invalidRecipient"})
public class ArrayOfInvalidRecipientsType {
     ...
     * why there is not a <CODE>set</CODE> method for the invalidRecipient property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link InvalidRecipientType }
     */
