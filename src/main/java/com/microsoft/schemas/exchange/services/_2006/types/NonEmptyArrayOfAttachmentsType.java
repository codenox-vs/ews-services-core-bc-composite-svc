...
/**
 * Java class for NonEmptyArrayOfAttachmentsType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfAttachmentsType",
        propOrder = {"itemAttachmentOrFileAttachment"})
public class NonEmptyArrayOfAttachmentsType {
     ...
     * why there is not a <CODE>set</CODE> method for the itemAttachmentOrFileAttachment property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link FileAttachmentType }
