...
/**
 * Java class for ArrayOfWorkingPeriod complex type.
 *
...
@XmlType(
        name = "ArrayOfWorkingPeriod",
        propOrder = {"workingPeriod"})
public class ArrayOfWorkingPeriod {
     ...
     * why there is not a <CODE>set</CODE> method for the workingPeriod property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link WorkingPeriod }
     */
