...
/**
 * Java class for ArrayOfMailTipsResponseMessageType complex type.
 *
...
@XmlType(
        name = "ArrayOfMailTipsResponseMessageType",
        propOrder = {"mailTipsResponseMessageType"})
public class ArrayOfMailTipsResponseMessageType {
     ...
     * why there is not a <CODE>set</CODE> method for the mailTipsResponseMessageType property.
     *
