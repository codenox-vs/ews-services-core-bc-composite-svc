...
/**
 * Java class for NonEmptyArrayOfOccurrenceInfoType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfOccurrenceInfoType",
        propOrder = {"occurrence"})
public class NonEmptyArrayOfOccurrenceInfoType {
     ...
     * why there is not a <CODE>set</CODE> method for the occurrence property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link OccurrenceInfoType }
     */
