...
/**
 * Java class for ArrayOfArraysOfTrackingPropertiesType complex type.
 *
...
@XmlType(
        name = "ArrayOfArraysOfTrackingPropertiesType",
        propOrder = {"arrayOfTrackingPropertiesType"})
public class ArrayOfArraysOfTrackingPropertiesType {
     ...
     * why there is not a <CODE>set</CODE> method for the arrayOfTrackingPropertiesType property.
     *
