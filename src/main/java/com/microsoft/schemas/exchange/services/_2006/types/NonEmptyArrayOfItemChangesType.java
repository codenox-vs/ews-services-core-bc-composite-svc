...
/**
 * Java class for NonEmptyArrayOfItemChangesType complex type.
 *
...
@XmlType(
        name = "NonEmptyArrayOfItemChangesType",
        propOrder = {"itemChange"})
public class NonEmptyArrayOfItemChangesType {
     ...
     * why there is not a <CODE>set</CODE> method for the itemChange property.
     *
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ItemChangeType }
     */
