...
/**
 * Java class for CreateItemType complex type.
 *
...
@XmlType(
        name = "CreateItemType",
        propOrder = {"savedItemFolderId", "items"})
public class CreateItemType extends BaseRequestType {
     ...
     *
     * @return possible object is {@link CalendarItemCreateOrDeleteOperationType }
     */
     ...
     *
     * @param value allowed object is {@link CalendarItemCreateOrDeleteOperationType }
     */
