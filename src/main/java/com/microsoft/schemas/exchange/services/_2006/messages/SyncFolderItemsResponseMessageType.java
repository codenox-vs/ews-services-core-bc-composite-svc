...
/**
 * Java class for SyncFolderItemsResponseMessageType complex type.
 *
...
@XmlType(
        name = "SyncFolderItemsResponseMessageType",
        propOrder = {"syncState", "includesLastItemInRange", "changes"})
public class SyncFolderItemsResponseMessageType extends ResponseMessageType {
     ...
     *
     * @return possible object is {@link SyncFolderItemsChangesType }
     */
     ...
     *
     * @param value allowed object is {@link SyncFolderItemsChangesType }
     */
